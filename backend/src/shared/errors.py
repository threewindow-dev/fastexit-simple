...
class BaseAppError(Exception):
    ...
    def __init__(
        self, message: str, origin_exc: Exception | None = None, code: str | None = None
    ):
...
class InsufficientBalanceError(DomainError):
    ...
    def __init__(
        self, balance: float, required: float, origin_exc: Exception | None = None
    ):
        super().__init__(
            f"Insufficient balance: {balance}, required: {required}", origin_exc
        )
