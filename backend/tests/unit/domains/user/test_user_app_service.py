...
class TestCreateUser:
    ...
    @pytest.mark.asyncio
    async def test_create_user_success(self, mock_user_repository, mock_transaction):
        ...
        service = UserAppService(mock_user_repository, mock_transaction)
    ...
    async def test_create_user_duplicate_username_raises_error(
        self, mock_user_repository, mock_transaction
    ):
...
class TestUpdateUser:
    ...
    @pytest.mark.asyncio
    async def test_update_user_success(self, mock_user_repository, mock_transaction):
...
class TestDeleteUser:
    ...
    @pytest.mark.asyncio
    async def test_delete_user_success(self, mock_user_repository, mock_transaction):
...
class TestGetUser:
    ...
    @pytest.mark.asyncio
    async def test_get_user_success(self, mock_user_repository, mock_transaction):
...
class TestListUsers:
    ...
    async def test_list_users_success(
        self, mock_user_repository, mock_transaction, sample_users
    ):
